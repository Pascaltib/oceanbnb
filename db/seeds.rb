...
arr = ["Ibiza", "Monaco", "Gibraltar", "Malaga", "Torrevieja", "Alicante", "Villajoyosa", "Valencia", "Cambrils", "Tarragona", "Barcelona", "Montpellier", "Marseille", "Toulon", "Cannes", "Nice", "Menton", "Sanremo", "Albenga", "Genoa"]
